...
//
// Esta es la versión 2.0 del programa de ecuación de segundo grado. En la que controlamos que a sea distinto de cero. a !=0.
...
int main()
{
	...
	//3.1 Ahora realizamos la estructura condicional para controlar el a !=0.
		...
		//3.2 Si a es distinto de 0 realizamos el cálculo de los dos resultados de la ecuación de 2º grado.
